...
const Login: FC<any> = () => {
    ...
    return (
        <Wrapper>
            ...
            <WrapperContent scoll position={"center"}>
                <View style={styles.content}>
                    ...
                    <View >
                        ...
                        <View>
                            <TouchableOpacity onPress={() => navigation.navigate("register")} activeOpacity={0.8} style={styles.register_btn}>
                                <Text style={styles.register_btn_text}>S'inscrire</Text>
                            </TouchableOpacity>
                        </View>

                        <TouchableOpacity onPress={() => navigation.navigate("forgot")} activeOpacity={0.8} style={styles.forgot_link}><Text style={styles.forgot_link_text}>Mot de passe oublié?</Text></TouchableOpacity>
                    </View>
            ...
            {click && user_loading && <SecondaryLoader text={"Veuillez patienter! connexion en cours.."} />}
        </Wrapper>
    )
}
